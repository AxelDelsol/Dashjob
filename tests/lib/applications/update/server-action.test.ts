...
import { action } from "@/lib/applications/update/internal-actions";
...
describe("server action - description", () => {
  it("rejects an empty description", async () => {
    ...
    expectInvalidField(actionState, "description", REQUIRED_FIELD);
  });
  ...
  it("converts empty string to null", async () => {
    ...
    expectValidField(actionState, "description", null);
  });
...
describe("server action - annualSalary", () => {
  it("rejects an empty annualSalary", async () => {
    ...
    expectInvalidField(actionState, "annualSalary", REQUIRED_FIELD);
  });
  ...
  it("converts empty string to null", async () => {
    ...
    expectValidField(actionState, "annualSalary", null);
  });
